...
var claims_component_1 = require('./../claim/claims.component');
var claims_component_edit_1 = require('./../claim/claims.component.edit');
var applications_component_1 = require('./../application/applications.component');
var applications_component_edit_1 = require('./../application/applications.component.edit');
var applications_component_mapClaims_1 = require('./../application/applications.component.mapClaims');
var roles_component_1 = require('./../role/roles.component');
var roles_component_edit_1 = require('./../role/roles.component.edit');
var trustedIdp_component_1 = require('./../trustedIdp/trustedIdp.component');
var trustedIdps_component_edit_1 = require('./../trustedIdp/trustedIdps.component.edit');
var idps_component_1 = require('./../idp/idps.component');
var idps_component_edit_1 = require('./../idp/idps.component.edit');
var idps_component_mapClaims_1 = require('./../idp/idps.component.mapClaims');
var idps_component_mapApplications_1 = require('./../idp/idps.component.mapApplications');
var idps_component_mapTrustedIdps_1 = require('./../idp/idps.component.mapTrustedIdps');
exports.routes = [
    /* Claims */
